...
print("[DetailGen3D]   4. LoadDetailGen3D_TextureModel - Load MV-Adapter for texturing")
print("[DetailGen3D]   5. DetailGen3D_Texture - Generate and bake texture onto mesh")
print("[DetailGen3D] ")
